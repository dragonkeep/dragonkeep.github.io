...
![](assets/基于obsidian搭建本地AI知识库/Pasted_image_20260507234959.png)

在第三方插件点下刷新就可以看到成功加载到claudian插件了。

![](assets/基于obsidian搭建本地AI知识库/Pasted_image_20260507235416.png)

如果你本地Win主机已经配置好了Claude-cli的话，一般就可以直接使用了。

![](assets/基于obsidian搭建本地AI知识库/Pasted_image_20260507235653.png)

如果你默认是像我一样使用npm安装的claude-cli可能会没有识别到路径，可以在设置里面手动配置`cli-wrapper.cjs`路径。

![](assets/基于obsidian搭建本地AI知识库/Pasted_image_20260507235810.png)
...
![](assets/基于obsidian搭建本地AI知识库/Pasted_image_20260508000212.png)

这里白嫖国产智谱AI的免费额度先将就用用，登录到[智谱](https://bigmodel.cn/)注册一个就能领免费额度了。

![](assets/基于obsidian搭建本地AI知识库/Pasted_image_20260508000543.png)

![](assets/基于obsidian搭建本地AI知识库/Pasted_image_20260508000444.png)
...
![](assets/基于obsidian搭建本地AI知识库/Pasted_image_20260508000649.png)
...
![](assets/基于obsidian搭建本地AI知识库/Pasted_image_20260508001755.png)

在QA这边设置好Embedding Model后，开启`Enable Semantic Search`选项后，就会自动开始索引你的笔记内容了。

![](assets/基于obsidian搭建本地AI知识库/Pasted_image_20260508001917.png)

索引完成后，默认的模式只有`chat`和`vault QA`，前者貌似无法读取你笔记内容，所以在设置配置默认模式为`vault QA`。

![](assets/基于obsidian搭建本地AI知识库/Pasted_image_20260508002250.png)
